      ...
      },
      {
        ...
        content: (
          <ul>
            ...
            <li><strong>Account data:</strong> your Cognito subject, Cognito username, email address, and authentication status when you choose to sign in with Google or create an email and password account. A password you set is stored and verified by Cognito; the app and its servers never see or log it in plain text. The Android app stores its sign-in session and PKCE material with Android Keystore encryption.</li>
