...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Decide whether challenge_token should be treated as safe-to-send analytics context (like room_code/public_id are explicitly NOT, being deliberately excluded) or should stay excluded for a documented reason
...
- [ ] #3 If it should stay excluded, document why in code (a one-line comment) so a future reader does not mistake the drop for a bug again
<!-- AC:END -->
