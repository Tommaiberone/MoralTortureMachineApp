...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Il testo del dilemma resta visibile durante il reveal
- [ ] #2 Il reveal mostra chi ha votato cosa, non solo un conteggio aggregato
- [ ] #3 Il reveal ha un testo reattivo allo split del voto, senza alcun countdown/suspense prima di mostrare il risultato
- [ ] #4 E' stata presa una decisione esplicita con l'utente sul timer del round (rimuovere/allungare/sostituire con avanzamento a consenso) prima di implementare il resto
- [ ] #5 La schermata finale sequenzia archetipi e premi invece di mostrarli tutti insieme
- [ ] #6 Sono aggiunte almeno due nuove categorie di premio oltre alle tre esistenti, solo se calcolabili dai dati già salvati
- [ ] #7 La lista finale usa il colore visivo di ogni archetipo
- [ ] #8 Esiste un bottone Rigioca con lo stesso gruppo, alternativo al solo ritorno alla home
- [ ] #9 Esiste un verdetto di gruppo generato dall'AI, con fallback se Groq non e' disponibile
<!-- AC:END -->
