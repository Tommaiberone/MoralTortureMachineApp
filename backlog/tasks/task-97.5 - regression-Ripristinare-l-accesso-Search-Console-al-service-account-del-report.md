...
- [ ] #2 Una nuova run del report restituisce righe Search Console oppure un risultato vuoto senza errore HTTP 403.
- [ ] #3 Il service account mantiene permessi minimi e non ottiene privilegi di pubblicazione del sito.
<!-- AC:END -->
