...
2026-07-29: deploy produzione completato nel run 30455802320; API/health 200, dashboard 200, endpoint admin protetto 401 senza credenziali e access-log live contiene path senza IP.
<!-- SECTION:NOTES:END -->
